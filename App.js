        ...
        <ScrollView onScroll={({ nativeEvent }) => {
          ...
          {data.map((e, i) => (
            <View key={i} style={styles.item}>
              ...
              <Image source={{ uri: "https://image.tmdb.org/t/p/original" + e.poster_path }} style={styles.img} />
              <Text style={{ fontSize: 16, color: "#FFFFFF", fontStyle: 'italic' }}>Release_date :{e.release_date}</Text>
              {isLoading ?
